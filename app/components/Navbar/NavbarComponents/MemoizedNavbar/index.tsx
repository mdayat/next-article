  ...
  return (
    <>
      ...
      <NavbarLinks
        ...
        btnClassName="font-poppins bg-blue-600 text-white px-3 py-1.5 rounded-md hover:bg-blue-700 duration-300 ease-in-out drop-shadow-xl ml-6 text-sm lg:ml-8 lg:text-base 2xl:ml-10 3xl:ml-12 3xl:text-xl"
      />
    </>
  );
};
