...
const HeroArticle = () => {
  return (
    <section className="pt-40">
      <article className="bg-gray-200 w-full md:w-[95vw] xl:w-[90vw] mx-auto p-2 py-4 sm:p-2.5 sm:py-5 md:p-4 lg:p-6 xl:p-8 2xl:p-10 md:rounded-lg 2xl:rounded-xl mb-10 md:mb-20">
        <figure className="relative w-full h-[200px] sm:h-[250px] md:h-[300px] lg:h-[350px] xl:h-[400px] 2xl:h-[500px]">
          <Image
        ...
        <div className="md:flex">
          ...
          <div className="mt-4 sm:mt-5 md:mt-6 lg:mt-7 md:basis-3/5">
            ...
            <figure className="flex items-center justify-start mt-4 sm:mt-5 md:mt-6 lg:mt-7">
              ...
              <Link href="mailto:example@gmail.com" prefetch={false}>
